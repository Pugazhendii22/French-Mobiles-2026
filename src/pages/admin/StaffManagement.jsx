...
const StaffManagement = () => {
  ...
  // Must sit below every hook. When this returned above the effect further up,
  // a render where userRole was still loading ran fewer hooks than the render
  // after it resolved, and React threw "rendered more hooks than expected".
